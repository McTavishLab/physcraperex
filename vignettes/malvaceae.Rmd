...
knitr::include_graphics("images/malvaceae-plant.jpg")
```
...
```{r get-tol-subtree, message=FALSE, warning=FALSE}
tolsubtree <- rotl::tol_subtree(ott_id = 279960)
ape::Ntip(tolsubtree)
grep("Pterygota_alata", tolsubtree$tip.label)
updated_tree_taxonname$tip.label
```
Eliminate ott and otu tags before comparison, othrwise nothing matches
