...
head(tip_values)
tolsubtree_ladderized <- ape::ladderize(tolsubtree)
...
length(edge_cols) == nrow(tolsubtree$edge)
...
par(fg="transparent")
phytools::plotSimmap(tolsubtree_wbl,type="fan",part=0.5,fsize=0.1, ftype="i", colors = cols)
