...
An easy way to visualize the ne wtips added into th eupdated tree compared to the original tree is coloring the barnches from those new tips with an outstanding color. We will use a function defined in this package to do so. 

The function takes as argument the path to the tree and otu info files:
...
plot_branches(treefile = mytreefile, otu_info_file = myotuinfofile)
```
