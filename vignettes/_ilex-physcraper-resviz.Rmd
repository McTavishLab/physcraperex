...
An easy way to visualize the new tips added into the updated tree compared to the original tree is coloring the tips and/or branches from those new tips with a highlighting color. We will use a function defined in this package to do so.
...
```{r plot-tips-and-branches, message = FALSE, eval = TRUE, dpi = 300, fig.retina = 3, results="asis", out.width="100%",  out.extra='style="background-color: #DCDCDC; padding:10px; display: inline-block;"', fig.width=2, fig.height=10}
