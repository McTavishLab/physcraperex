...
The next figure shows in green the nodes that were resolved by the original tree:
...
The following figure shows in blue the nodes that align with the original tree and in green the nodes that were resolved with the updated data.
