...
```{r cotree-plot2, message = FALSE, eval = TRUE, dpi = 300, fig.retina = 3, results="asis", out.width="90%",  out.extra='style="background-color: #8B008B; padding:10px; display: inline-block;"', fig.height=10}
updated_tree_taxonname2 <- updated_tree_taxonname
updated_tree_taxonname2$edge.length <- updated_tree_taxonname$edge.length*10 # for viz purposes!
