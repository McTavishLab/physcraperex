...
### Downloading the alignment manually from TreeBASE
...
```
physcraper_run.py -s pg_2827 -t tree6577 -a data-raw//alignments/T1281-M2478.nex -as nexus -db /local_blast_db -o examples/pg_2827_tree6577 
```
