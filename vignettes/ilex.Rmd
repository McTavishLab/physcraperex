...
ilex_new_tree <- ape::read.tree(file = "../data/pg_2827_tree6577/run_T1281-M2478/RAxML_bestTree.2020-06-05")
...
Run the densitree plot
```{r densitree-plot, message = FALSE, eval = TRUE, dpi = 300, fig.retina = 3, fig.width = 2, out.width="100%", fig.height = 20, results="asis"}
phangorn::densiTree(x = trees)
```

Let's plot them face to face
```{r}
cotree <-  phytools::cophylo(ilex2003, ilex_new_tree_labeled)
phytools::plot.cophylo(x = cotree)
```
...
Plot the node labels from conflict tree and maybe color them according to status
