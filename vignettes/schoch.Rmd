...
# Current run
```
physcraper_run.py -s pg_238 -t tree109 -a ../physcraperex/data-raw/alignments/Tr5276-M3939-mod.nex -as nexus -o ../physcraperex/data/schoch_ascomycota_1_2020.06.06
```
