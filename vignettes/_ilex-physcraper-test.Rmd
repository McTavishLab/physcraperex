...
We looked for the NCBI accession numbers reported in the [supplementary material of the original publication](https://bsapubs.onlinelibrary.wiley.com/action/downloadSupplement?doi=10.3732%2Fajb.92.2.352&file=ajb20352-sup-0002.pdf) for
...
Inspecting the sequences, all three contain a gap in the middle of 100 undetermined nucleotide bases (Ns). The original alignment removed these Ns, however, Physcraper drops these sequence because they are unalignable without any manual curation.
...
updated_taxonname.tree and labelled_tag.tre are exactly the same tree
