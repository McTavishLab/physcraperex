...
```
# Running the Physcraper test

## Locally

```
physcraper_run.py -tf ../data-raw/ilex-test/tree6577_pg_2827_pruned.tre -tfs newick -a data-raw/alignments/T1281-M2478.nex -as nexus -ti ../data-raw/ilex-test/pruned_tree_tip_labels_mapped.main.json -db local_blast_db -o data/ilex-test-local
```

## Remotely
```
physcraper_run.py -tf ../data-raw/ilex-test/tree6577_pg_2827_pruned.tre -tfs newick -a data-raw/alignments/T1281-M2478.nex -as nexus -ti ../data-raw/ilex-test/pruned_tree_tip_labels_mapped.main.json -o data/ilex-test-remote
```
